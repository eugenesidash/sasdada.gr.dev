...
<div class="button_div fl_l" style="line-height:15px;margin-left:172px;margin-top:15px"><button onclick='location.href = "/payeer";'style="width:161px">Пополнить баланс</button></div>

<div class="button_div_gray fl_l" style="line-height:15px;margin-left:172px;margin-top:15px"><button onClick="payment.addbox();" style="width:161px">Передать голоса</button></div>
