...
<div class="fm_item_info"><center>Сделайте внешний вид удобным, и привлекательным, для вас и других. Поддерживаются форматы JPG, PNG и GIF.<br /> -  Если у вас имеется облик, то вы можете его убрать. <br /><a class="cursor_pointer" onClick="fon_facemy.del('{uid}')"><b>Очистить фон</b></a></center>
...
<div class="fon_facemy_add"><div class="fon_facemy_hidden" style="float:left;margin-right:10px;" onClick="fon_facemy.reload_facemy('{uid}')">Сохранить</div>
