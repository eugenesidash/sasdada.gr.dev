...
<div class="infowalltext">{date} [owner]<a href="/" class="fl_r" onClick="commentsGroups.delet_page_comm({id}, '{hash}'); return false" id="full_del_but_{id}">Удалить</a>[/owner]</div>
</div>
</div>
