...
<div class="photo_close" onClick="PhotoGroups.Close('{close-link}'); return false;"></div>
 <div class="photo_bg">
  ...
  <div class="photo_leftcol">
   ...
   <div class="button_div fl_l"><button id="add_comm" onClick="commentsGroups.add({id}); return false">Отправить</button></div>[/add-comm]
   </div></div>
  <div class="photo_rightcol">
   Из альбома:<br />
   <a href="albums-{aid}" onClick="Page.Go(this.href); return false">{album-name}</a><br /><br />
   Отправитель:<br />
