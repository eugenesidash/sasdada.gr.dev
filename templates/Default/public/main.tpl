...
<div class="ava fl_r" style="margin-right:0px" onMouseOver="groups.wall_like_users_five_hide()">
 ...
 <div class="menuleft" style="margin-top:5px">
  ...
  <div id="acc_settings_ic"> [admin]<a href="/" onClick="groups.loadphoto('{id}'); return false"><img class="icon addfr_fan" src="{theme}/images/fre.png" alt="" /><div>Изменить фотографию</div></a></div>
  <div id="gifts_ninstall"><span id="del_pho_but" class="{display-ava}"><a href="/" onClick="groups.delphoto('{id}'); return false;"><img class="icon addfr_fan" src="{theme}/images/dekk.png" alt="" /><div>Удалить фотографию</div></a></span></div>
 
 
 
 <div id="edit_profile_ic"> <a href="/" onClick="groups.inviteBox('{id}'); return false"><img class="icon addfr_fan" src="{theme}/images/fdr.png" alt="" /><div>Пригласить друзей</div></div></a>  
 <div id="gifts_456"><a href="/stats?gid={id}"><img class="icon addfr_fan" src="{theme}/images/stas.png" alt="" /><div>Статистика страницы</div></a></div>

 <div id="invite_fr_ic"><a href="/albums-{public-id}" onClick="Page.Go(this.href); return false"><img class="icon addfr_fan" src="{theme}/images/fott.png" alt="" /><div>Альбомы</div></a></div>

 <div id="gifts_ic"><a href="/" onClick="groups.editform(); return false"><img class="icon addfr_fan" src="{theme}/images/ipr.png" alt="" /><div>Управление страницей</div></a>[/admin]</div>
 </div>
  <div class="publick_subscblock">
   ...
   <div id="no" class="{no}" style="text-align:left">
    ...
    <a href="/public{id}" onClick="groups.wall_tell_g('{id}'); return false">Рассказать друзьям</a><div class="wall_tell_all" style="margin-right:55px;margin-top:5px;opacity:1"></div>
...
<div class="{lastnews-css}" id="descr_display"><div class="flpodtext">Новости:</div> <div class="flpodinfopublic" id="e_descr" style="width: 295px;">{lastnews}</div></div>
 ...
 [admin]<div class="public_editbg fl_l no_display" id="edittab1">
  ...
  <div class="texta">Новости группы:</div>
   <textarea id="lastnews" class="inpst" style="width:260px;height:80px">{edit-lastnews}</textarea>
  <div class="mgclr"></div>
 ...
 <div class="mgclr"></div>
  ...
  <div class="mgclr"></div>
   ...
   <div class="texta">&nbsp;</div><div class="button_div fl_l"><button onClick="groups.delpublic('{id}'); return false" id="pubDel">Удалить страницу</button></div><br><br>
   <div class="mgclr"></div>
