<div id="data">
<div class="search_form_tab" style="background:#fff;margin-top:-15px">
...
<input type="text" 
	class="videos_input" 
	style="width:400px;margin-top:10px;color:#c1cad0" 
	maxlength="65" 
	id="title"
...
<textarea 
	...
	id="question" 
	style="width:400px;height:100px;color:#c1cad0"
