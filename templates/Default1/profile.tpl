...
<div class="ava">
<center>[owner]<div class="cover_newava" >[/owner][not-owner]{ocovss}[/not-owner]
<div id="owner_photo_wrap">
  <div id="owner_photo_top_bubble_wrap">
  [owner]<div id="owner_photo_top_bubble">
        <div class="owner_photo_bubble_delete_wrap" title="Удалить"onClick="Profile.DelPhoto(); $('.profileMenu').hide(); return false;">
          <div class="owner_photo_bubble_delete"></div>
        </div>
  </div>[/owner]
</div>
<div class="b_photo "><span id="ava">
[owner]<a class="cursor_pointer" onClick="Profile.ava('{ava}', '{user-id}')">[/owner]
[not-owner]<a href="" onClick="Profile.ava('{ava}', '{user-id}'); return false">[/not-owner]
<img src="{ava}" id="ava_{user-id}"title="" /></a></span>
<div style="margin-left: 1px;margin-top: -75px;z-index:40;position:absolute;">{user_znachok}</div>
[owner] <div id="owner_photo_bubble_wrap">
  ...
  </div><div class="owner_photo_bubble_action owner_photo_bubble_action_crop"onClick="Profile.DelPhoto(); $('.profileMenu').hide(); return false;"">
  <span class="owner_photo_bubble_action_in">Удалить фотографию</span>
</div></div>
  </div>[/owner]
</div></div>
[not-owner]{ocovs}[/not-owner][owner]</div>[/owner]
</center>
...
<div id="adds"><a href="/balance" onClick="Page.Go(this.href); return false" class="color777"><center> Мой баланс: <b>{ubm} голосов</b></center></a></div>
<a href="#" onclick="doLoad.data(1); fon.addbox()">Фон</a>
<a href="/" onClick="znachok.box({user-id},1); return false"><img class="icon addfr_ic" src="{theme}/images/spacer.gif" alt="" /><div>Прикрепить значок</div></a>
<a href="/editmypage" onClick="Page.Go(this.href); $('.profileMenu').hide(); return false;"><img class="icon edit_ic" src="{theme}/images/spacer.gif" alt="" /><div>Редактировать страницу</div></a>
...
<a href="/settings"><img class="icon editphoto_ic" src="{theme}/images/nastr.png"><div>Мои Настройки</div></a>
...
[blacklist]<div class="leftcbor">
 ...
 [/happy-friends][/owner]
<br>
 [friends]<div class="albtitle cursor_pointer" onclick="Page.Go('/friends/{user-id}')">Друзей <b id="gramTextFriends">({friends-num})</b><div class="mono_ico" onmouseover="myhtml.title('1', 'Показать всех друзей', 'newBBlockl')" id="newBBlockl1"></div></div>
 <div class="newmesnobg" style="padding:0px;padding-top:10px;">{friends}<div class="clear"></div>
 </div>[/friends]
 [online-friends]<div class="albtitle cursor_pointer" onclick="Page.Go('/friends/online/{user-id}')">Друзей на сайте <b id="gramTextFriends">({online-friends-num})</b><div class="mono_ico_frOnline" onmouseover="myhtml.title('2', 'Показать всех друзей на сайте', 'newBBlockl')" id="newBBlockl2"></div></div>
 <div class="newmesnobg" style="padding:0px;padding-top:10px;">{online-friends}<div class="clear"></div>
 </div>[/online-friends]
 [subscriptions]<div class="albtitle cursor_pointer" onClick="subscriptions.all({user-id}, '', 1)">Интересные страницы <b id="gramTextSubscr">({subscriptions-num})</b><div class="mono_ico_subscr" onMouseOver="myhtml.title('3', 'Показать всех интересных людей', 'newBBlockl')" id="newBBlockl3"></div></div>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{subscriptions}<div class="clear"></div>
 </div>[/subscriptions]
 [groups]<a onClick="groups.all_groups_user('{user-id}')" style="text-decoration:none;"><div class="albtitle cursor_pointer">Интересные страницы <span id="groups_num">({groups-num})</span><div class="mono_ico_groups" onmouseover="myhtml.title('4', 'Показать все интересные страницы', 'newBBlockl')" id="newBBlockl4"></div></div></a>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{groups}<div class="clear"></div>
 </div>[/groups]
 [videos] <div class="albtitle cursor_pointer" onClick="Page.Go('/videos/{user-id}'); return false">Видеозаписи <b id="gramTextVideos">({videos-num})</b><div class="mono_ico_videos" onMouseOver="myhtml.title('5', 'Показать все видеозаписи', 'newBBlockl')" id="newBBlockl5"></div></div>
 <div class="newmesnobg" style="padding-right:0px;padding-bottom:0px;">{videos}<div class="clear"></div>
 </div>[/videos]
 [notes]<div class="albtitle cursor_pointer" onclick="Page.Go('/notes/{user-id}')">Заметки<b id="gramTextNotes"> ({notes-num})</b><div class="mono_ico_notes" onmouseover="myhtml.title('6', 'Показать все заметки', 'newBBlockl')" id="newBBlockl6"></div></div>
 <div class="newmesnobg" style="padding-right:0px;padding-left:5px">{notes}<div class="clear"></div>
 </div>[/notes]
 [docs]<div class="albtitle">Документы <span>({docs-num})</span><div><a href="/docs" style="color:#21578B;" onClick="Page.Go(this.href); return false">Все</a></div></div>
...
<div class="profiewr">
 [owner]<div class="set_status_bg no_display" id="set_status_bg">
  <input type="text" id="status_text" class="status_inp" value="{status-text}" style="width:440px;" maxlength="255" onKeyPress="if(event.keyCode == 13)gStatus.set()" />
 ...
 <div class="titleu"> {name} {lastname}{user_real} <div class="online_time" style="z-index:200;">{online}</div>[owner]<div  onclick="Page.Go('/editmypage')"><a class="icon edit_ic" onmouseover="myhtml.title('88', 'Редактировать страницу', 'newBBlockl')" id="newBBlockl88"></div></a>[/owner]</div>
 <div class="status">
...
<br>
 ...
 [albums]<a href="/albums/{user-id}" onclick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle">Альбомы<b id="gramTextAlbums"> ({albums-num})</b><div class="mono_ico_albums" onmouseover="myhtml.title('7', 'Показать все альбомы', 'newBBlockl')" id="newBBlockl7"></div></div></a><div style="background:#f7f9fa">{albums}<div class="clear"></div></div></a>[/albums]
 [phet] 
...
[/phet]
 [audios]<div id="jquery_jplayer"></div><input type="hidden" id="teck_id" value="1" /><a href="audio{user-id}"><div class="albtitle" style="margin-top:0px">Аудиозаписи <b id="gramTextAudios">({audios-num})</b><div class="mono_ico_audios" onmouseover="myhtml.title('8', 'Показать все аудиозаписи', 'newBBlockl')" id="newBBlockl8"></div></div>{audios}<div class="clear"></div><br></a>[/audios]
 [gifts]<a href="/gifts{user-id}" onclick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="margin-top:-1px">{gifts-text}<b id="gramTextGifts"></b><div class="mono_ico_gifts" onmouseover="myhtml.title('9', 'Показать все подарки', 'newBBlockl')" id="newBBlockl9"></div></div><center>{gifts}</center><div class="clear"></div></a>[/gifts]
 <a href="/wall{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle" style="border-bottom:0px;margin-bottom:-1px;margin-top:-1px;"><b id="wall_rec_num">[no-records]На стене не оставлена не одна[/no-records]{wall-rec-num}</b> <b id="gramTextWall">запись</b><div class="mono_ico_wall"></div></div></a>
 [privacy-wall]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-1px">
 ...
 [wall-link]<center><span id="wall_all_record"></span><div onclick="wall.page('{user-id}'); return false" id="wall_l_href" class="cursor_pointer"><div class="photo_all_comm_bg wall_upgwi" id="wall_link">к предыдущим записям</div></div></center>[/wall-link][/blacklist]
 [not-blacklist]<div class="err_yellow" style="font-weight:normal;margin-top:5px">{name} ограничил(а) доступ к своей странице.</div>[/not-blacklist]
