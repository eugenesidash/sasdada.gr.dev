<h1 onClick="reg.step1(); return false" id="reg_lnk">Новые пользователи</h1>
{usernew}

<img src=/generator.gif border=0></a>

<div class="descr_site"><b>Сайт.ru</b> -Сервис организации и отражения социальных взаимоотношений, позволяет всегда находиться на связи со своими родными и близкими, друзьями и коллегами и просто знакомыми, приятными и интересными людьми! 'Сайт.ru' - это универсальное средство общения по интересам, поиска новых друзей и знакомых. Вы можете делиться медиафайлами, документами, новостями и событиями, ограничивая круг лиц, которым они будут доступны.</div>
