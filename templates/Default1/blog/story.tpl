...
$(document).ready(function(){
	$('.blog_left_tab').css('min-height', ($('.blog_left_tab').height()+35)+'px').css('height', ($('.blog_left').height()+35)+'px');
});
</script>
<style>.speedbar{color:#5081b1}</style>
<div class="blogthr"></div>
<div class="blog_left fl_l">
<div class="notes_ava"><img src="{theme}/images/support2.png" alt="" /></div>
<div class="one_note" style="width:420px">
