...
<div class="fl_l margin_top_5">Р’ Р°Р»СЊР±РѕРјРµ СЃРѕРѕР±С‰РµСЃС‚РІР° {photo-num}</div>
<div class="button_div_gray fl_r"><button id="upload_2">Р—Р°РіСЂСѓР·РёС‚СЊ РЅРѕРІСѓСЋ С„РѕС‚РѕРіСЂР°С„РёСЋ</button></div>
<div class="clear"></div>
</div>
