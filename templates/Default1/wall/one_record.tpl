[record]<div class="wallrecord wall_upage2" id="wall_record_{rec-id}" style="padding-bottom:4px;margin-top:5px">
 ...
 <div class="infowalltext_f clear">
  ...
  <div class="public_likes_user_block no_display" id="public_likes_user_block{rec-id}" onMouseOver="groups.wall_like_users_five('{rec-id}')" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" style="margin-left:490px">
