...
<div id="Xjquery_jplayer"></div>
 ...
 <div class="staticPlbgTitle">
  ...
  <div class="staticpl_repeat" onClick="player.refresh()" onMouseOver="myhtml.title('1', 'Повторять эту композицию', 'xPlayerVolrefresh')" id="xPlayerVolrefresh1"></div>
  <div class="staticpl_rand" onClick="player.rand()" onMouseOver="myhtml.title('1', 'Перемешать', 'xPlayerRand')" id="xPlayerRand1"></div>
