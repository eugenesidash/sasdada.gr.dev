<div class="photo_row" id="album_{aid}" [owner]style="cursor:move"[/owner]><div class="cont">
    <a class="img_link [yes-photos]no_photo[/yes-photos] [yesdescr]photo_album_title_show[/yesdescr] [owner]edit_owner[/owner]">
		...
		[owner]<div class="photo_album_info" onClick="AlbumsGroups.EditBox({aid}); return false" title="????????????? ??????">
			<div class="photo_album_info_back"></div>
			<div class="photo_album_info_cont"></div>
		</div>
		<div class="photo_album_info" onClick="AlbumsGroups.EditCover({aid}); return false" title="???????? ???????" style="right:31px;">
			<div class="photo_album_info_back"></div>
		...
		<div class="photo_album_info" onClick="AlbumsGroups.Delete({aid}, '{hash}'); return false" title="??????? ??????" style="right:56px;">
			<div class="photo_album_info_back"></div>
