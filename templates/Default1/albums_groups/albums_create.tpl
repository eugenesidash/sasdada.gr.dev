<script type="text/javascript" src="{theme}/js/albums_groups.create.js"></script>
<input type="hidden" id="pid" value="{pid}"/>
<div style="padding:1px 14px">
 <div class="videos_text" style="margin: 12px 0px 5px;">Название</div>
 <input type="text" class="videos_input" id="name" maxlength="100" style="width:370px;padding:3px;" />
 <div class="videos_text" style="margin: 0px 0px 5px;">Описание</div>
 <textarea class="videos_input" id="descr" style="width:370px;height:70px;padding:3px;"></textarea>
