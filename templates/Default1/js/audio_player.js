...
var player = {
  open: function(type, uid, aid){
    ...
    if(!jQaudioPage){
	  if(ln){
        ...
        if(tPos == 60){
          $('.staticPlbg').animate({'margin-top': -520});
 ...
 close: function(){
  ...
  change_list: function(uid){
	...
	jQaudioPage = 1;
  	$('#speedbar, .staticpl_bottom, .staticpl_ictop').hide();
	$('#page').html('');
    $('.staticPlbg').addClass('page_audio').css('margin', '-10px').css('margin-top', '-10px');
    $('.staticpl_progress_bar').css('width', '655px');
    $('.staticpl_audios').css('width', '860px').css('min-height', '390px');
    $('.staticpl_shadow').css('width', '778px');
    $('#jQpSeachVal').css('width', '795px').css('float', 'left');
    $('#jQpLoad').css('margin-left', '706px');
    $('.staticpl_rtitle').css('max-width', '625px');
    $('.staticpl_trackname').css('width', '670px');
	$('.staticpl_panel').show();
  ...
  reestablish: function(){
	jQaudioPage = 0;
	var pos = $('#fplayer_pos').offset().left-200;
	$('.staticpl_bottom, .staticpl_ictop').show();
	$('.staticPlbg').removeClass('page_audio').css('margin', '20px').css('margin-top', '60px').css('margin-left', pos+'px').css('margin-top', '-510px');
	$('.staticpl_progress_bar').css('width', '250px');
	$('.staticpl_audios').css('width', '455px').css('min-height', '334px');
