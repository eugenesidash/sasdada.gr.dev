			...
			$tpl->load_template('chat/msg.tpl');
				...
				if($row) {
					...
					$text = replase_smile($text);
                        ...
                        $workcom .= '<div class=\'fotocom\' style=\'margin-bottom:5px;\' id=\'comment_'.$row_com['id'].'\'><div class=\'ava_mini\' style=\'float:left;width:50px\'><a href=\'/u'.$row_com['user_id'].'\' onclick="Page.Go(this.href); return false"><img src=\''.$avau.'\' style=\'border-radius: 5px;\'></a></div>
<div style=\'margin-bottom:1px;margin-left:80px;\'><div class=\'infowalltext\'><a class=\'cursor_pointer\' onclick="chatz.otvet('.$sql_us['user_search_pref'].'); return false">'.$sql_us['user_search_pref'].'</a>('.$date.')</div></div>

						<div id=\''.$new.'\' style=\'float:left;width:650px;background: '.$newcom.';border-bottom: solid 1px #c9c9c9;border-right: solid 1px #c9c9c9;-moz-border-radius: 2px;-webkit-border-radius: 2px;border-radius: 2px;padding: 5px;margin-bottom: 5px;height:35px;\'>
						<div id=\''.$new.'\' style=\'margin-left: -13px;width: 0;height: 0;border-top: 10px solid transparent;border-bottom: 10px solid transparent;border-right: 8px solid #fff;float:left;\'></div>
...
<div style=\'margin-bottom:1px;margin-left:80px;\'><div class=\'infowalltext\'><a class=\'cursor_pointer\' onclick="chatz.otvet('.$sql_us['user_search_pref'].'); return false">'.$sql_us['user_search_pref'].'</a>('.$date.')</div></div>
						...
						<div style=\'float:left;width:650px;background: #fff;border-bottom: solid 1px #c9c9c9;border-right: solid 1px #c9c9c9;-moz-border-radius: 2px;-webkit-border-radius: 2px;border-radius: 2px;padding: 5px;margin-bottom: 5px;height:35px;\'>
						<div style=\'margin-left: -13px;width: 0;height: 0;border-top: 10px solid transparent;border-bottom: 10px solid transparent;border-right: 8px solid #fff;float:left;\'></div>
						<div class=\'fl_r\'>'.$delcom.'</div>
<div class=\'walltext\' style=\'margin-top:2px\'>'.$text.'</div>
</div>
<div class=\'clear\'></div>
